...
<form method="get" action="">
    <input type="text" name="invalid" placeholder="Enter name or account number" value="<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>">
    ...
    <%
        ...
        if (keyword != null && !keyword.trim().isEmpty()) {
            try {
                ...
                String sql = "SELECT * FROM users WHERE name LIKE ? OR id LIKE ?";
