...
<div class="register-container">
   ...
   >
    ...
    <form action="AdminRegisterCustomerServlet" method="post">
    ...
    <form action="AdminRegisterCustomerServlet" method="post" onsubmit="return confirm('Are you sure you want to delete this customer?');">
